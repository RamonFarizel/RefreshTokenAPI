...
using RefreshTokenAPI.Business;
using RefreshTokenAPI.Business.Interface;
using RefreshTokenAPI.Models.Security;
...
namespace RefreshTokenAPI.Controllers
{
    ...
    public class LoginController : ControllerBase
    {
        ...
        [HttpPost]
        public object Post(
            [FromBody]AccessCredential credenciais,
            //[FromServices]LoginBusinessImp Login,
            ...
            [FromServices]IDistributedCache cache)
        {
            ...
            if (credenciais != null && !String.IsNullOrWhiteSpace(credenciais.UserID))
            {
                ...
                {
                    var usuarioBase = _loginBusiness.FindUser(credenciais.UserID);
